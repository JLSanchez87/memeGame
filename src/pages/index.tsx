...
export default function Home() {
	...
	return (
		<Layout>
			<h1 className="text-2xl pb-5">Welcome to memeSpaghetti! 🍝</h1>
			<div>
				<form className="flex flex-col gap-4" onSubmit={handleFormSubmit}>
					...
					<input
						...
						id="roomid"
					/>
					<button className="rounded border p-5 bg-red-500 group text-black shadow hover:shadow-lg transition-all duration-200 hover:scale-125">
						<p className="font-bold hover:animate-wiggle">
							Join the spagehetti! 🎉
						</p>
					</button>
				</form>
